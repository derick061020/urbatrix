...
<title>BAHÍA MAR · Plan de Pagos · {{ $referencia }}</title>
...
.toolbar {
  ...
  background: var(--green-bg); color: #ffffff;
  font-family: 'Inter', sans-serif;
}
.toolbar-title { font-size: 12px; letter-spacing: .14em; text-transform: uppercase; opacity: .7; }
.toolbar-btn {
  appearance: none; border: none; cursor: pointer;
  background: #ffffff; color: var(--green-bg);
  font-size: 13px; font-weight: 600; letter-spacing: .03em;
  padding: 9px 18px; border-radius: 6px;
}
.toolbar-btn:hover { background: #fff; }

.sheet { background: #fff; width: 210mm; min-height: 297mm; margin: 0 auto; position: relative; padding-bottom: 40px; }
...
.hdr-ref .f { color: rgba(255,255,255,.6); }

.body { padding: 20px 44px 48px; }

.sec-title {
  font-size: 7px; font-weight: 600; color: var(--ink-mute);
  letter-spacing: .24em; text-transform: uppercase;
  padding-bottom: 5px; border-bottom: 1.5px solid var(--ink); margin-bottom: 12px;
}
.p { font-size: 8.5px; color: var(--ink-mid); line-height: 1.7; margin-bottom: 6px; }
...
.doc-title { font-size: 24px; font-weight: 300; color: var(--ink); letter-spacing: -.02em; line-height: 1.1; }
.doc-title strong { font-weight: 700; }
.doc-sub { font-size: 8px; color: var(--ink-mute); letter-spacing: .06em; margin-top: 5px; }
.doc-meta { text-align: right; }
.doc-meta-label { font-size: 6.5px; font-weight: 500; color: var(--ink-mute); letter-spacing: .16em; text-transform: uppercase; margin-bottom: 2px; }
.doc-meta-val { font-size: 9px; font-weight: 600; color: var(--ink); }

.prep-line { font-size: 8px; color: var(--ink-mute); padding: 7px 0 14px; letter-spacing: .04em; }
.prep-line .f { font-size: 8px; }

.unit-row { display: flex; gap: 0; border-top: 1px solid var(--rule); border-bottom: 1px solid var(--rule); margin-bottom: 16px; }
.unit-cell { flex: 1; padding: 10px 14px 10px 0; }
.unit-cell + .unit-cell { padding-left: 14px; border-left: 1px solid var(--rule-lt); }
.unit-lbl { font-size: 6.5px; font-weight: 500; color: var(--ink-mute); letter-spacing: .14em; text-transform: uppercase; margin-bottom: 3px; }
.unit-val { font-size: 10px; font-weight: 600; color: var(--ink); }

.inst-table { width: 100%; border-collapse: collapse; margin-bottom: 16px; }
.inst-table thead tr { border-bottom: 1.5px solid var(--ink); }
.inst-table th { padding: 0 12px 5px; text-align: left; font-size: 7px; font-weight: 600; color: var(--ink-mute); text-transform: uppercase; letter-spacing: .18em; }
.inst-table th:last-child { text-align: right; }
.inst-table td { padding: 5px 12px; font-size: 9px; color: var(--ink-mid); border-bottom: 1px solid var(--rule-lt); }
.inst-table td:first-child { color: var(--ink-mute); font-weight: 600; font-size: 8px; }
.inst-table td:last-child  { text-align: right; font-weight: 600; color: var(--ink); }
.inst-table tbody tr:nth-child(even) td { background: var(--field-bg); }
.inst-table tr:last-child td { border-bottom: none; }
.inst-table .total-row { border-top: 1.5px solid var(--ink); }
.inst-table .total-row td { padding-top: 9px; font-size: 9px; font-weight: 700; color: var(--ink); border-bottom: none; }
.inst-table .total-row td:last-child { font-size: 10.5px; }

.stages { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; padding: 14px 0 16px; margin-bottom: 16px; }
.stages > div { border: 1px solid var(--rule); border-radius: 8px; padding: 14px 16px 16px; }
.stage-num { font-size: 6.5px; font-weight: 600; color: var(--ink-mute); letter-spacing: .2em; text-transform: uppercase; margin-bottom: 8px; }
.stage-pct { font-size: 30px; font-weight: 700; color: var(--ink); letter-spacing: -.03em; line-height: 1; margin-bottom: 2px; }
.stage-pct sup { font-size: 14px; font-weight: 400; vertical-align: super; }
.stage-amount { font-size: 9.5px; font-weight: 600; color: var(--ink-mid); margin-bottom: 10px; padding-bottom: 10px; border-bottom: 1px solid var(--rule-lt); }
.stage-title { font-size: 7.5px; font-weight: 700; color: var(--ink); letter-spacing: .06em; text-transform: uppercase; margin-bottom: 5px; }
.stage-desc { font-size: 7.5px; color: var(--ink-mid); line-height: 1.6; }
.stage-tag { display: block; margin-top: 7px; font-size: 7.5px; font-weight: 600; color: var(--green); letter-spacing: .04em; }

.sig-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 32px; margin-top: 14px; break-inside: avoid; page-break-inside: avoid; }
...
.sig-box   { border-top: 1px solid var(--ink); border-bottom: 1px solid var(--rule-lt); height: 38px; margin-bottom: 5px; }
...
.footer-c { font-size: 6.5px; color: rgba(255,255,255,.22); text-align: center; }
.footer-r { font-size: 7px; color: rgba(255,255,255,.3); }
.footer-r .f { color: rgba(255,255,255,.4); font-weight: 500; }
...
@media screen {
  .sheet { box-shadow: 0 4px 24px rgba(0,0,0,.10); margin: 16px auto; }
}
</style>
</head>
<body>
...
<div class="sheet">
  ...
  <div class="body">
    ...
    <div class="prep-line">
      Preparado para &nbsp;·&nbsp; <span class="f">{{ $comprador_nombre }}</span> &nbsp;·&nbsp; <span class="f">{{ $comprador_email }}</span>
    </div>
    ...
    <div style="border-top:1.5px solid var(--ink); padding-top:16px;">
      ...
      <div class="sig-grid">
        ...
        <div>
          ...
          <div class="sig-name">{{ $vendedor_nombre ?? __('Landmass S.R.L.') }}</div>
