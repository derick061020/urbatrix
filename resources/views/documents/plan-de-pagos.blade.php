...
<title>Makai · Plan de Pagos · {{ $referencia }}</title>
...
.hdr-ref .f { color: rgba(241,237,227,.6); }
...
.footer-c { font-size: 6.5px; color: rgba(241,237,227,.22); text-align: center; }
.footer-r { font-size: 7px; color: rgba(241,237,227,.3); }
.footer-r .f { color: rgba(241,237,227,.4); font-weight: 500; }
