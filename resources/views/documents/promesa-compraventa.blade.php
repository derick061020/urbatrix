...
.ph-name { font-size: 10px; font-weight: 600; color: rgba(255,255,255,.7); letter-spacing: .18em; }
.ph-right { text-align: right; }
.ph-doc { font-size: 7px; font-weight: 500; color: rgba(255,255,255,.3); letter-spacing: .14em; text-transform: uppercase; }
.ph-pg { font-size: 8px; color: rgba(255,255,255,.4); margin-top: 3px; }
    ...
    <div class="cover-parties">
      <div>
        ...
        <div class="cover-party-detail">
          <b>RNC:</b> 1-33-17485-5 &nbsp;·&nbsp; <b>Reg. Mercantil:</b> #222530SD<br>
