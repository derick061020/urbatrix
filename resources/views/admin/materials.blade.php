...
<style>
    ...
    .mat-field:focus { border-color:#074540; box-shadow:0 0 0 3px rgba(7,69,64,.18); }
    ...
    .mat-drop:hover { border-color:#074540; background:#f5f8f6; }
    ...
    .mat-icon-btn:hover { border-color:#074540; background:#f5f8f6; }
    .mat-icon-btn.is-active { border-color:#074540; background:#074540; color:#fff; box-shadow:0 0 0 3px rgba(7,69,64,.18); }
</style>
@endpush
