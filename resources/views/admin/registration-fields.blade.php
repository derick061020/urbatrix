...
<div class="bg-gray-100 min-h-screen w-full">
    ...
    <h1 class="text-3xl font-semibold text-[#5c4a32] mb-1">Registration Fields</h1>
    <p class="text-gray-500 mb-6">Add and edit registration fields. Once created, the registration fields can be sorted, edited or removed via the table below.</p>
    <hr class="border-gray-300 mb-6">

    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between mb-5">
            <h2 class="font-semibold text-gray-700">Registration Fields</h2>
        ...
        <table class="w-full text-sm text-left">
            <thead>
                <tr class="border-b border-gray-200 text-xs text-gray-500 uppercase">
                    ...
                    <th class="py-3 pr-4 font-semibold">Enabled</th>
                    ...
                    <th class="py-3 pr-4 font-semibold">Delete</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td colspan="6" class="py-8 text-center text-gray-400 text-sm">No registration fields found.</td>
                </tr>
            </tbody>
        </table>
    </div>
