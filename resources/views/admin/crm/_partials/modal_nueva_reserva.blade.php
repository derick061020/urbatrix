    ...
    <form method="POST" action="{{ route('admin.crm.reservation.create') }}" class="w-[520px] bg-white rounded-2xl overflow-hidden" data-nueva-reserva>
        ...
        <div class="p-6 space-y-4">
            ...
            <div data-pane="existing" class="hidden">
                <label class="text-[12px] font-semibold text-ink-700">Buscar cliente</label>
                ...
                <p class="text-[11px] text-ink-500 mt-1.5">La reserva se vinculará a la cuenta seleccionada.</p>
            </div>

            {{-- ── Modo: cliente nuevo ── --}}
            <div data-pane="new" class="space-y-4">
                <div>
                    <label class="text-[12px] font-semibold text-ink-700">Nombre del cliente</label>
                    <input type="text" name="cliente_nombre" data-new-input placeholder="Nombre completo" class="crm-input pl-3 mt-1">
                </div>
                <div>
                    ...
                    <p class="text-[11px] text-ink-500 mt-1.5"><i class="pi pi-envelope text-[10px] mr-1"></i> Se enviará una invitación para que active su cuenta y cree su contraseña.</p>
                </div>
            </div>
