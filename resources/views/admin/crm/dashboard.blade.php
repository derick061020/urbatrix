                        ...
                        @forelse(($proyectos ?? collect()) as $p)
                            ...
                            <tr class="hover:bg-ink-50">
                                ...
                                <td class="px-3 py-3.5 text-right">
                                    <a href="{{ route('admin.crm.proyecto.detalle', $p->id) }}" class="inline-flex items-center justify-center w-8 h-8 rounded-lg border border-ink-200 bg-white text-ink-500 hover:text-brand hover:border-brand hover:bg-brand-tint transition-colors" title="{{ __('Ver') }}" aria-label="{{ __('Ver') }}"><i class="pi pi-eye text-[14px]"></i></a>
                                </td>
                            </tr>
                        @empty
