...
<div class="bg-gray-100 min-h-screen w-full">
    <div class="p-8">
        ...
        <h1 class="text-3xl font-semibold text-[#5c4a32] mb-1">Landing</h1>
        <p class="text-gray-500 mb-6">Configure landing settings.</p>
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-4">
            ...
            <div class="flex items-center justify-between mb-1">
                <h2 class="text-base font-semibold text-gray-800">Views</h2>
                <button type="button"
            ...
            <p class="text-sm text-gray-500 mb-5">Configure the views shown to the end user.</p>

            {{-- Enabled Sub-card --}}
            <div class="border border-gray-200 rounded-lg p-5 mb-4">
                <h3 class="text-sm font-semibold text-gray-800 mb-1">Enabled</h3>
                <p class="text-sm text-gray-500 mb-4">Enable / disable the views shown to the end user.</p>
            ...
            <div class="border border-gray-200 rounded-lg p-5">
                <h3 class="text-sm font-semibold text-gray-800 mb-1">Default</h3>
                <p class="text-sm text-gray-500 mb-5">Set the default view shown to the end user.</p>
                ...
                <div class="flex items-center">
                    ...
                    <label class="flex flex-col items-center gap-1 cursor-pointer" style="min-width: 120px;">
                        ...
                        <span class="text-xs text-gray-700">Plan</span>
                    </label>

                    <label class="flex flex-col items-center gap-1 cursor-pointer" style="min-width: 120px;">
                        <input type="radio" name="default-view" class="accent-[#4a5240] w-5 h-5 cursor-pointer">
                        <span class="text-xs text-gray-700">List</span>
                    </label>
