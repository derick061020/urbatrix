  ...
  <tr>
    <td align="center" style="padding:24px 16px;">
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 1px 3px rgba(10,13,20,0.06);">
        ...
        <!-- HERO -->
        <tr>
          <td style="background-color:#222530;padding:28px 36px 24px 36px;">
            @if($eyebrow)<p style="margin:0 0 8px 0;font-size:9px;font-weight:600;color:#e11019;letter-spacing:0.24em;text-transform:uppercase;">{{ $eyebrow }}</p>@endif
