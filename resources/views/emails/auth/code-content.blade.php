...
<tr>
  <td style="background-color:#0f2710;padding:26px 36px 22px 36px;">
    <p style="margin:0 0 7px 0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:9px;font-weight:500;color:rgba(241,237,227,0.4);letter-spacing:0.24em;text-transform:uppercase;">Verificación de seguridad</p>
...
<tr>
  <td style="background-color:#ffffff;padding:32px 36px 8px 36px;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
      <tr>
        <td align="center" style="background-color:#0b1c0a;padding:22px 16px;border-radius:10px;">
          <p style="margin:0 0 8px 0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:9px;font-weight:500;color:rgba(184,150,46,0.8);letter-spacing:0.2em;text-transform:uppercase;">Tu código</p>
    ...
    <p style="margin:20px 0 0 0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:12px;color:#8a8a84;line-height:1.6;">Este código caduca en <strong style="color:#4a4a46;">{{ $minutes }} minutos</strong>. Si no solicitaste esto, ignora este mensaje y tu cuenta seguirá segura.</p>
  </td>
</tr>
