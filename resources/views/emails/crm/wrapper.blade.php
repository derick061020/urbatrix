      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background-color:#f7f6f3;padding:20px 36px;border-top:1px solid #e8e7e3;">
            <p style="margin:0 0 2px 0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:11px;color:#4a4a46;">{{ __('Un cordial saludo,') }}</p>
            <p style="margin:0 0 2px 0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:12px;font-weight:600;color:#1a1a18;">Equipo {{ $group }}</p>
            <p style="margin:0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:10px;color:#8a8a84;">{{ $email }} · {{ $phone }}</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background-color:#0b1c0a;padding:16px 36px;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
              <tr>
                <td style="vertical-align:middle;">
                  <p style="margin:0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:10px;font-weight:500;color:rgba(241,237,227,0.4);letter-spacing:0.18em;text-transform:uppercase;">{{ $brand }} · {{ $group }}</p>
                  <p style="margin:4px 0 0 0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:10px;color:rgba(241,237,227,0.2);">{{ $location }}</p>
                </td>
                <td align="right" style="vertical-align:middle;">
                  <p style="margin:0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:9px;color:rgba(241,237,227,0.15);letter-spacing:0.1em;">{{ $website }}</p>
                </td>
              </tr>
            </table>
          </td>
